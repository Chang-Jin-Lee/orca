...
(`terminal-query-authority.md`, ships with PR #7214); in kill-switch-off byte
mode only the 2031 reply is answered and Command Code output is not scraped,
matching the pre-gate status quo.
